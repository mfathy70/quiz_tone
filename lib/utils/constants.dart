...
final String appName = "Quizz Tone";
final String packageName = "com.quizz.tone";
...
final List<String> supporatedLocales = ['en', 'hi', 'ar', 'fr', 'ru', 'tr'];
//
...
final String databaseUrl = "https://admin.quizztone.com";
...
final String getLatexQuestionUrl = "${baseUrl}get_maths_questions";
...
final int latexQuestionDurationInSeconds = 60;
...
final int waitForOpponentDurationInSeconds = 30;
...
final String payoutRequestCurrency = '\$';
